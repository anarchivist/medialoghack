...
public class BlackboardArtifact implements SleuthkitVisitableItem {
	 ...
	 * @throws org.sleuthkit.datamodel.TskException exception thrown if a critical error occurs within tsk core and attribute was not added
	 */
	 ...
	 * @throws org.sleuthkit.datamodel.TskException exception thrown if a critical error occurs within tsk core and attributes were not added
	 */
	 ...
	 * @throws org.sleuthkit.datamodel.TskException exception thrown if a critical error occurs within tsk core and attributes were not queried
	 */
